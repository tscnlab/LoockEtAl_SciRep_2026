...
library(Hmisc)
#Read Data
data=read.csv('SpitschanSleepSurvey_DATA_2024-08-07_1229.csv')
#Setting Labels

label(data$record_id)="Study ID"
label(data$redcap_survey_identifier)="Survey Identifier"
label(data$participant_information_sheet_and_informed_consent_timestamp)="Survey Timestamp"
label(data$slypos_consent_01)="Please indicate whether you are above or below the legal age of majority."
label(data$slypos_consent_02___1)="Please indicate whether you agree to take part. (choice=Yes, I agree to take part.)"
label(data$slypos_consent_03___1)="Please indicate whether you agree to take part. (choice=Yes, I agree to take part.)"
label(data$slypos_consent_04___1)="Please confirm that you have parental assent. (choice=Yes, I have discussed this study with my parents or legal guardians, who agreed that I could take part.)"
label(data$slypos_consent_05___1)="Please confirm that this is your first time participating in the survey. (choice=I am participating this survey for the first time and I affirm to provide accurate information to the best of my knowledge.)"
label(data$participant_information_sheet_and_informed_consent_complete)="Complete?"
...
label(data$further_information_about_you_complete)="Complete?"
...
label(data$your_sleep_environment_complete)="Complete?"
...
label(data$your_sensitivity_to_light_complete)="Complete?"
...
label(data$your_sleep_complete)="Complete?"
...
label(data$your_wakeup_and_sleep_times_complete)="Complete?"
...
label(data$your_light_behaviour_complete)="Complete?"
#Setting Units


#Setting Factors(will create new variable for factors)
data$slypos_consent_01.factor = factor(data$slypos_consent_01,levels=c("1","2"))
data$slypos_consent_02___1.factor = factor(data$slypos_consent_02___1,levels=c("0","1"))
data$slypos_consent_03___1.factor = factor(data$slypos_consent_03___1,levels=c("0","1"))
data$slypos_consent_04___1.factor = factor(data$slypos_consent_04___1,levels=c("0","1"))
data$slypos_consent_05___1.factor = factor(data$slypos_consent_05___1,levels=c("0","1"))
data$participant_information_sheet_and_informed_consent_complete.factor = factor(data$participant_information_sheet_and_informed_consent_complete,levels=c("0","1","2"))
...
data$further_information_about_you_complete.factor = factor(data$further_information_about_you_complete,levels=c("0","1","2"))
...
data$your_sleep_environment_complete.factor = factor(data$your_sleep_environment_complete,levels=c("0","1","2"))
...
data$your_sensitivity_to_light_complete.factor = factor(data$your_sensitivity_to_light_complete,levels=c("0","1","2"))
...
data$your_sleep_complete.factor = factor(data$your_sleep_complete,levels=c("0","1","2"))
...
data$your_wakeup_and_sleep_times_complete.factor = factor(data$your_wakeup_and_sleep_times_complete,levels=c("0","1","2"))
...
data$your_light_behaviour_complete.factor = factor(data$your_light_behaviour_complete,levels=c("0","1","2"))

levels(data$slypos_consent_01.factor)=c("I am above the legal age of majority (usually 18 years of age).","I am younger than the legal age of majority.")
levels(data$slypos_consent_02___1.factor)=c("Unchecked","Checked")
levels(data$slypos_consent_03___1.factor)=c("Unchecked","Checked")
levels(data$slypos_consent_04___1.factor)=c("Unchecked","Checked")
levels(data$slypos_consent_05___1.factor)=c("Unchecked","Checked")
levels(data$participant_information_sheet_and_informed_consent_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$further_information_about_you_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$your_sleep_environment_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$your_sensitivity_to_light_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$your_sleep_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$your_wakeup_and_sleep_times_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$your_light_behaviour_complete.factor)=c("Incomplete","Unverified","Complete")
